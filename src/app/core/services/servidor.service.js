...
var ServidorService = (function () {
    ...
    ServidorService.prototype.getByPesquisa2 = function (nome, instituicao, cargo, orgao, setor, habilidade, funcao, limite, offset) {
        var _this = this;
    ...
    ServidorService.prototype.getById = function (id) {
        ...
        return this.httpClientService.get("/servidores/" + id + "/")
            .map(function (res) {
            return _this.jsonToServidor(res.json() || {});
        });
    };
    ServidorService.prototype.getByIdSemFoto = function (id, idLogado) {
        var _this = this;
    ...
    ServidorService.prototype.getFotoById = function (id) {
        var _this = this;
    ...
    ServidorService.prototype.updateImg = function (id, base64Img) {
